...
<body>
    ...
    <?php
        ...
        if (!isset($_SESSION['user_email'])) {
            die("You must be logged in to view donor details.");
        }

        $user_email = $_SESSION['user_email'];

        $sql = "SELECT * FROM blood_donors WHERE Email = ?";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>You haven't submitted your donor details yet.</p>";
        }
